  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-0 right-0 w-125 h-125 rounded-full bg-cyan-500/10 blur-[150px]" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center mt-24">
          ...
          >
            ...
            <p className="mt-8 text-slate-400 leading-7 text-base sm:leading-8">
            ...
            <p className="mt-6 text-slate-400 leading-7 text-base sm:leading-8">
            ...
            <div className="mt-12  flex flex-wrap sm:flex-row gap-4">
