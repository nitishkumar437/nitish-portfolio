...
const GradientButton = ({
  ...
  return (
    <a
      href={href}
      download={download}
      className={`group relative inline-flex w-full sm:w-auto items-center justify-center overflow-hidden rounded-xl px-7 py-4 font-semibold transition-all duration-300 hover:scale-105 active:scale-95
${
  primary
    ? "bg-linear-to-r from-sky-500 via-cyan-500 to-sky-600 text-white shadow-[0_0_30px_rgba(56,189,248,.35)]"
